...
<nav>
    ...
    <!--<div style="text-align:center; margin:auto; background-color:darkgray; padding:15px;"> -->
        ...
        <div id="manageRequests" style="background-color:lightgray;text-align:center; margin:auto;border:3px solid darkgray; border-radius: 4px; color:green; font-weight: bold; padding: 35px; overflow:auto;">
            <h4>Enter the username of who<br> you would like to remove<br>from your friends list<br> (case sensitive)!</h4>
                <hr>
                <form method="POST" action="RemoveFriend.php"> 
                <h3 style=" color:black;">Friend's Username</h3>
                <input type="text" id= "friendsUsername" name="friendsUsername" placeholder="JohnDoe123" required style="text-align:center;"/><br><br>
                <input type="submit" name="RemoveFriend" style="color:red;" value="Remove Friend"/>
                </form>
                <hr> 
           ...
           echo '<br><br><span style="color:black; background-color:darkgray; cursor:pointer; padding:5%;border-radius:5px;">'.$rows2['username'].'</span><br>'; 
        ...
        for(i=0;i<spans.length;i++)
            spans[i].addEventListener('click', function(){
               document.getElementById('friendsUsername').value = this.innerHTML;
